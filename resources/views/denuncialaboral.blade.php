...
<body>
    ...
    <div class="banner-denuncia">
        <div class="max-w-screen-2xl mx-auto">
            <div class="w-50 lg:pb-16 xs:pb-8 xl:pt-48 lg:pt-44 xs:pt-32 xs:px-4 md:px-4">
                <p class="2xl:text-7xl xs:text-2xl font-bold xs:text-center 2xl:text-left text-white">¡No te quedes</p>
                <p class="font-bold 2xl:text-8xl xs:text-2xl tc-red xs:text-center 2xl:text-left">en silencio!</p>
                <p class="2xl:text-2xl xl:text-lg xs:text-base text-white 2xl:mt-16 xs:mt-4 lg:text-center 2xl:text-left">
                    En <span class="font-semibold tgreen-youtube">The Mendoza Law Firm</span> queremos que cada colaborador se<span class="font-semibold">sienta seguro y respetado</span>. 
                </p>
                <p class="2xl:text-2xl xl:text-lg xs:text-base text-white 2xl:mt-8 xs:mt-4 2xl:mb-8 xs:mb-4 lg:text-center 2xl:text-left">
                    Sabemos que en ocasiones es difícil hablar sobre lo que sucede en el entorno laboral, pero es fundamental enfrentar situaciones de <span class="font-semibold italic tc-red">abuso y conflicto</span>.
                </p>
                {{-- <p class="2xl:text-2xl xl:text-lg xs:text-base text-white 2xl:mt-8 xs:mt-4 2xl:mb-8 xs:mb-4 lg:text-center 2xl:text-left">
    ...
    <div class="banner-green">
        <div class="max-w-screen-2xl mx-auto py-14">
            <div class="w-3-5 align-top inline-block text-center xs:px-2 xl:mx-0">
                <p class="font-bold 2xl:mt-28 xs:mt-4 italic lg:text-4xl xl:text-5xl xs:text-2xl text-white">¿Has sido testigo o víctima de alguno de estos comportamientos?</p>
                <ul class="mt-8 text-left">
                    <li class="mt-8 text-white text-xl inline-block"><img src="/images/icono-error.webp" class="w-8 inline-block mr-2" alt="icono-error"><span class="font-bold inline-block">Acoso sexual:</span> Comentarios inapropiados o insinuaciones que generan incomodidad.</li>
                    <li class="mt-8 text-white text-xl inline-block"><img src="/images/icono-error.webp" class="w-8 inline-block mr-2" alt="icono-error"><span class="font-bold inline-block">Abuso de poder:</span> Uso injusto de autoridad para intimidar o aprovecharse de los empleados.</li>
                    <li class="mt-8 text-white text-xl inline-block"><img src="/images/icono-error.webp" class="w-8 inline-block mr-2" alt="icono-error"><span class="font-bold inline-block">Abuso laboral:</span> Exigencias desmedidas, maltrato verbal o desconsideración por el bienestar del equipo.</li>
                    <li class="mt-8 text-white text-xl inline-block"><img src="/images/icono-error.webp" class="w-8 inline-block mr-2" alt="icono-error"><span class="font-bold inline-block">Conflictos de interés:</span> Situaciones que afectan la imparcialidad en el trabajo, como gerentes que contratan a sus familiares o compañeros de trabajo cuya relación personal interfiere en el desempeño.</li>
                </ul>
                    ...
                    <form id="form-denuncia-main">
                        <div id="form-denuncia">
                            ...
                            <div class="relative mt-4 bg-white">
                                ...
                                <label for="img-evidencia" class="custom-file-label">Subir Imagen de Evidencia</label>
                                <style>
                                    .hidden-input {
                                        display: none;
                                    }
                                ...
                                <input class="hidden" id="img-evidencia" type="file" name="img_evidencia" placeholder="Imagen de Evidencia" onchange="handleFileChange(event, 'foto_nombre')" accept="image/*">
                            </div>
    ...
    <div class="max-w-screen-2xl mx-auto text-center py-12">
        <p class="tgreen-youtube lg:text-6xl xs:text-2xl font-semibold mb-8">¡Queremos escucharte!</p>
        <p class="text-black xl:text-2xl lg:text-xl">Hemos creado un canal seguro y confidencial para que puedas expresar tus inquietudes sin miedo a represalias. Tu voz es importante para construir un ambiente laboral justo y equitativo.</p>
    </div>
    <div class="bg-black">
        <div>
    ...
    <div id="loading-overlay" bis_skin_checked="1">
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        setTimeout(function() {
                            document.getElementById('popup-overlay').style.display = 'none';
                            document.getElementById('popup-success').style.display = 'none';
                            document.getElementById('form-denuncia-main').reset();
                            $('.renderfoto_nombre').empty();
                        }, 5000);
                    },
