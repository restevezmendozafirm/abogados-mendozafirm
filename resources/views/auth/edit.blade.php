    ...
    <div class="flex-1">
        ...
        <div class="p-10 w80 mx-auto">
            <div class="flex justify-between mb-8 items-center">
                <h1 class="text-3xl font-bold text-gray-800 mb-8 inline-block">Editar Usuario</h1>
                ...
                <div class="w-full light-grey py-8 pb-4 px-8 text-center rounded-3xl shadow-xl">
                    <div class="flex-auto p-6 bg-login">
                        <form method="POST" action="{{ route('user.actualizar', $user->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="flex flex-wrap justify-between mb-6">
                                ...
                                <div class="md:w-1/2 pr-4 pl-4">
                                    <input id="lname" type="text"
                                        class="block appearance-none w-full py-1 px-2 mb-1 text-lg leading-normal bg-white text-gray-800 border border-gray-200 rounded @error('name') bg-red-700 @enderror"
                                        name="lname" value="{{$user->lname }}" autocomplete="lname" autofocus>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-wrap justify-between mb-6">
                                <label for="password" class="md:w-1/3 pr-4 pl-4 pt-2 pb-2 mb-0 leading-normal text-md-end text-lg text-black font-bold">{{ __('Contraseña') }}<span class="text-red-500">&nbsp;*</span></label>
                                <div class="md:w-1/2 pr-4 pl-4">
                                ...
                                <div class="md:w-1/2 pr-4 pl-4">
                                    <select class="block appearance-none w-full py-1 px-2 mb-1 text-lg leading-normal bg-white text-gray-800 border border-gray-200 rounded" name="type" id="type">
                                        @if (Auth::user()->type == 'Admin')
                                            ...
                                            <option value="Capacitador" @if($user->type == "Capacitador") selected @endif>Capacitador</option>
                                        @endif
                                        <option value="Agente" @if($user->type == "Agente") selected @endif>Agente</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-wrap  mb-0">
                                <div class="w-full pr-4 pl-4">
                                    <button type="submit"
                                        class="bg-red my-4 rounded-full hover-bg-red-600 py-2 px-6 user-registration-btn uppercase font-bold tracking-wide text-white font-sans hover:scale-110 transition-all">{{ __('Editar') }}</button>
                                </div>
                            </div>
